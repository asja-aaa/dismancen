...
public class ForecastController {
    ...
    public @ResponseBody
    String fileInputForecast(@RequestParam String filePath)  {
        ...
        if(DATA_TYPE.JSON.getType().contains(filePath.substring(index+1))) {
            ...
            FileDto<Forecast> fileDto = JSON.parseObject(Str,new TypeReference<FileDto<Forecast>>(){});
...
//            }
            ...
            DisasterInfo<Forecast> disasterInfo = (DisasterInfo<Forecast>) xstream.fromXML(Str);
